...
export default function sitemap(): MetadataRoute.Sitemap {
  const staticRoutes = ["/", "/news", "/news/chinese-mathematicians-fields-medal-2026", "/universities", "/provinces", "/china-map", "/cities", "/life", "/community", "/majors", "/scholarships", "/scholarship-opportunities", "/scholarship-assessment", "/free-study-plan", "/why-china", "/consultation", "/contact", "/culture", "/global-checkin"];
  ...
  return allRoutes.flatMap((route) => supportedLocales.map((locale) => {
