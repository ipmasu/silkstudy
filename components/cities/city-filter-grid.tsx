    ...
    <div className="mt-10">
        ...
        <>
          <section id="city-filter-results" className="mt-10 rounded-3xl bg-[#fff3d7] px-4 py-8 sm:px-6">
            ...
            <div className="mt-7 rounded-2xl border border-amber-200 bg-white p-6 text-center shadow-sm">
              ...
              <Link href={`${prefix}/free-study-plan`} className="mt-5 inline-flex min-h-11 items-center rounded-full bg-red-600 px-6 py-3 text-sm font-bold text-white hover:bg-red-700">
      ...
      <section className="mt-14 rounded-3xl bg-red-600 p-8 text-white">
        <div className="max-w-3xl">
          ...
          <Link href={`${prefix}/free-study-plan`} className="ml-3 mt-6 inline-flex min-h-11 items-center rounded-full bg-slate-950 px-6 py-3 font-bold text-white hover:bg-slate-800">
            {isZh ? "获取免费留学方案 →" : "Get Your Free Study Plan ->"}
          </Link>
        </div>
      </section>
